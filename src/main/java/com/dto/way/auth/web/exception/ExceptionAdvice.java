package com.dto.way.auth.web.exception;

import com.dto.way.auth.web.response.ApiResponse;
import com.dto.way.auth.web.response.code.ErrorReasonDTO;
import com.dto.way.auth.web.response.code.status.ErrorStatus;
...
public class ExceptionAdvice extends ResponseEntityExceptionHandler {
    ...
    public ResponseEntity onThrowException(GeneralException apiException, HttpServletRequest request) {
